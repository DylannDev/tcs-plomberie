...
export const reviewLink =
  "https://www.google.com/search?sca_esv=ceaa0c7f27a790d3&si=APYL9bs7Hg2KMLB-4tSoTdxuOx8BdRvHbByC_AuVpNyh0x2KzQlz25UyBP0snsFPUtdyAwvydqDbK7V5F0nMAUD3OUIKIRBCCat0hhHSUMYBi41D4cFtohgTYhJuAy_zzD-9CIsosRUSfq16jNcWuW6h0TwfAt01hfkk9KX8T7THroXlvlp9ISImNqnvYjxgWH35BOje5CHBPWzydAWbeLndRk0ZFTrZuBbc7_0GBLeZYyt7IPd0OfWDR8SUz6DGDconMPTdmcfnhYFLEG6ITQI-d3yoWrsiLw%3D%3D&q=Thermo+Clim+Sanitaire+-+Plombier+-+Chauffagiste+-+Climatisation+-+Montpellier+-+Installation+-+D%C3%A9pannage+-+Entretien+Avis&sa=X&ved=2ahUKEwjLtPDxiOmMAxUvV6QEHWH4CJwQ0bkNegQINhAD&biw=1800&bih=1004&dpr=2";
...
export const reviews = [
  {
    ...
    name: "Alice Fgr",
    message:
      "Merci pour la prestation d'entretien c'est parfait. J'ai retrouvé une bonne ventilation de ma climatisation réversible et un air propre. Bravo pour le professionnalisme, je vous recommande l'entreprise Thermo Clim Sanitaire",
    stars: 5,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    name: "Suzan Bozkurt",
    message:
      "Ce fut un réel plaisir de pouvoir travailler avec Thermo Clim Sanitaire. Très professionnel et efficace. Nous avons fait faire l'installation de notre Cumulus et installation de nos sanitaires. Un travail impeccable propre et soigné. Nous recommandons véritablement son travail.",
    stars: 5,
  },
  {
    id: "4",
    name: "Pierre Sargousse",
    message:
      "Personne très professionnelle. Le contact par téléphone a été rapide et efficace (par envoi de simples photos), il est arrivé le jour J avec tout le nécessaire. L'intervention a été ensuite très bien réalisée. Je recommande à 100 %",
    stars: 5,
  },
  {
    id: "5",
    name: "Réan",
    message:
      "Service rapide et efficace, j'ai fait appel l'entreprise Thermo Clim Sanitaire à Montpellier pour un dépannage urgent et il est arrivé rapidement, le technicien a été professionnel et a résolu le problème en peu de temps, je vous recommande fortement leurs services !",
    stars: 5,
  },
  {
    id: "6",
  ...
  },
  {
    ...
    message:
      "Ma salle de bain était refaite à la perfection. Je suis très satisfait de la prestation professionnelle effectuée par vos services. Je recommande à tout le monde les yeux fermés. Merci",
    stars: 5,
  },
  {
    id: "9",
    name: "Germain Valero",
    message:
      "Thermo Clim sanitaire est une entreprise très sérieuse, très bon travail et tient les délais",
    stars: 5,
  },
  {
    id: "10",
    name: "Judith Jimenez Cruz",
    message:
      "Intervention trés professionnelle et rapide. Tarifs trés raisonnables ! Je vous commande vivement cette entreprise !",
    stars: 4,
  },
  {
    id: "11",
    name: "Camille",
    message:
      "Professionnel méticuleux et efficace. Merci encore pour le travail accompli dans ma salle de bain et ma cuisine. Je recommande +++",
    stars: 5,
  },
  {
    id: "12",
    name: "Maxime Berkpinar",
    message:
      "Bon plombier , il a intervenu plusieurs fois pour des travaux de plomberie dans mon restaurant et chez moi 👍",
    stars: 5,
  },
  {
    id: "13",
    name: "Erdogan",
    message:
      "Très professionnel, à l'écoute du client et surtout travail proprement, je conseille les yeux fermé.",
    stars: 5,
  },
  {
    id: "14",
    name: "Pierre Ona",
    message: "Top plombier réactif efface à appeler sans hésiter je recommande",
    stars: 5,
  },
  {
    id: "15",
    name: "Ana Rusnac",
    message:
      "le meilleur et le plus responsable artisan Je recommande avec la plus grande confiance !",
    stars: 5,
  },
  {
    id: "16",
    name: "El chapo",
    message: "Franchement bravo très professionnel",
    stars: 5,
  },
  {
    id: "17",
    name: "Attila Zac",
    message:
      "Dispo , rapide , travail professionnel ! Je vous recommande vivement 👍",
    stars: 5,
  },
  {
    id: "18",
    name: "Sandrine Pages",
    message: "Réactif (rdv très rapide), ponctuel, sérieux!",
    stars: 5,
  },
  {
    id: "19",
    name: "Mme Dominique Nurit",
    message: "Sérieux, efficace et correct en prix. What else!",
    stars: 5,
  },
  {
    id: "20",
    name: "Daniel Bozkurt",
    message: "Efficacité , rapide , travaille propre 👍 merci",
    stars: 5,
  },
  {
    id: "21",
    name: "sas FAM",
    message:
      "Merci 1000 fois pour la rapidité d'intervention, Service et réparation irréprochable, très sympa ,très bonne communication , je recommande à 100%",
    stars: 5,
  },
  {
    id: "22",
    name: "Johannes Adedemi",
    message:
      "Merci pour ta réactivité un dimanche de Pâques ! Je recommande à mille pour-cent. Professionnel et très humain. Merci 🙏🏾",
    stars: 5,
  },
  {
    id: "23",
...
export const faqHomepage = [
  {
    ...
    answer:
      "Nous intervenons généralement dans la journée pour toute urgence plomberie, chauffage ou climatisation à Montpellier et ses alentours. Pour une installation planifiée, nous vous proposons un rendez-vous rapide selon vos disponibilités.",
  },
  {
    id: "item-2",
  ...
  },
  {
    ...
    answer:
      "Oui, tous nos devis sont gratuits et sans engagement. Que ce soit pour un dépannage ou une installation, nous vous envoyons un devis clair avant chaque intervention.",
  },
  {
    id: "item-4",
