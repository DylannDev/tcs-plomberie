...
export default function ChauffageSeoPage({
  cityName,
  heroIntro,
  sections,
  faq,
}: CitySeoPageProps) {
  const images = cityServiceImages.chauffage;
  ...
  return (
    <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-full md:w-1/2 relative aspect-square md:aspect-auto lg:aspect-square max-h-[350px] md:max-h-full lg:max-h-[500px] md:h-auto overflow-hidden">
              <Image
                ...
                alt={`Installation, entretien et dépannage de chauffage à ${cityName} - TCS Plomberie`}
                fill
      ...
      <Faq
        data={faq}
        title={`Questions sur le chauffage à ${cityName}`}
        badge="FAQ"
        isRichText={true}
      />
